...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  return (
    <div className="w-full">
      <label htmlFor="multi-select-input" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
        {label}
      </label>
              ...
              <div className="flex flex-col">
                {options.map((option) => (
                  <div key={option.value}>
                    <button
                      type="button"
                      className={"hover:bg-primary/5 w-full cursor-pointer rounded-t border-b border-gray-200 dark:border-gray-800 text-left"}
